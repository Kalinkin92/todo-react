...
export default class App extends Component {
    ...
    state = {
        todoData: [
            ...
            { label: 'Попить чайку', important: false, done: false, id: 1 },
            { label: 'Развезти плату', important: true, done: false, id: 2 },
            { label: 'Посмотреть видос про электроэнергию из желудей', important: false, done: false, id: 3 }
        ],
        filter: '',
        status: 'all'
    };
